...
BOT_TOKEN = environ.get("BOT_TOKEN", "5491810950:AAEgNQLCVBj3skGYxhC3RKWjlTSSZEuYRUQ")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002123681765').split()]
...
# FSUB
auth_channel = environ.get('AUTH_CHANNEL', "-1002079668962")
